...
def training_step(num_iteration):
...
def train_model(file_path):
    ...
    num_filters_layer_2 = 32

    num_filters_layer_3 = 64
    ...
    first_conv_layer = create_convolutional_layer(
        ...
        num_filters=num_filters_layer_1)
    second_conv_layer = create_convolutional_layer(
        input=first_conv_layer,
        num_input_channels=num_filters_layer_1,
        conv_filter_size=filter_size,
        num_filters=num_filters_layer_2)
    third_conv_layer = create_convolutional_layer(
        input=second_conv_layer,
        num_input_channels=num_filters_layer_2,
        conv_filter_size=filter_size,
        num_filters=num_filters_layer_3)

    layer_flat = create_flatten_layer(third_conv_layer)
    ...
    training_step(num_iteration=10000)
